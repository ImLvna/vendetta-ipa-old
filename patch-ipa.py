...
shutil.copy('icons/VendettaIcon60x60@2x.png', 'workspace/vendetta/Payload/Discord.app/VendettaIcon60x60@2x.png')
shutil.copy('icons/VendettaIcon76x76@2x~ipad.png', 'workspace/vendetta/Payload/Discord.app/VendettaIcon76x76@2x~ipad.png')
...
with open('workspace/vendetta/Payload/Discord.app/Info.plist', 'rb') as info_plist:
    ...
    parsed_plist['CFBundleIcons']['CFBundlePrimaryIcon']['CFBundleIconFiles'] = ['VendettaIcon60x60']
    parsed_plist['CFBundleIcons~ipad']['CFBundlePrimaryIcon']['CFBundleIconName'] = 'VendettaIcon'
    parsed_plist['CFBundleIcons~ipad']['CFBundlePrimaryIcon']['CFBundleIconFiles'] = ['VendettaIcon60x60', 'VendettaIcon72x72']

    
    print('Removing supported devices limit')
    parsed_plist.pop('UISupportedDevices')
